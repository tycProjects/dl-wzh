package com.generated.ayaanleacademy;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "AYAANLE ACADEMY" : title;
    ...
    // its own "AYAANLE ACADEMY" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "AYAANLE ACADEMY/" + filename);
