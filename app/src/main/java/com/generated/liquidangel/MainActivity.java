package com.generated.liquidangel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SplashController loading = new LoadingSplashView(this, Color.parseColor("#000000"), "Liquid Angel", 3);
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "Liquid Angel" : title;
    ...
    // its own "Liquid Angel" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "Liquid Angel/" + filename);
