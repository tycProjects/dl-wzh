package com.generated.modrithrock;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "ModrithRock" : title;
    ...
    // its own "ModrithRock" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "ModrithRock/" + filename);
