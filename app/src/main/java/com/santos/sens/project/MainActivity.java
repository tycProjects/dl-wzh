package com.santos.sens.project;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static class SignalOffIcon extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            paint.setColor(Color.parseColor("#ff1a1a"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setColorSchemeColors(Color.parseColor("#ff1a1a"));
        ...
        navOverlay.setBackgroundColor(Color.parseColor("#ff1a1a"));
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "Auxilio Santos" : title;
    ...
    // its own "Auxilio Santos" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "Auxilio Santos/" + filename);
